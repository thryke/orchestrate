...
# Test Engine to be used with Client1.py. Each line of conversation keeps printing until
# User says to go forward or back or pause. Client is paused until that input.
